...
public class StateSet {	
	...
	public String getParameters() {
		...
		parameters += "toggle_ac1=" + String.valueOf(toggle_ac1) + "&";
	...
	public void updateStates(String response){
		try {
			...
			toggle_ac1 = jsonObject.getInt("status_ac");
	...
	public void updateStatesExtern(int turnOf){
		turn_off = turnOf;
	}
	...
	public void printStates() {
		...
		System.out.printf("toggle_ac1 = %d \n", toggle_ac1);
